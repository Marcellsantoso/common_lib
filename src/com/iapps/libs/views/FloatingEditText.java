...
/**
 * Created by IntelliJ IDEA. User: keith. Date: 14-10-30. Time: 15:57.
 */
@SuppressLint("Recycle")
public class FloatingEditText
	extends EditText {
	...
	public FloatingEditText(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		mUnderlineHeight =
				attributes.getDimensionPixelSize(R.styleable.FloatingEditText_floating_edit_text_underline_height,
						getResources().getDimensionPixelSize(R.dimen.floating_edit_text_underline_height));
		mUnderlineHighlightedHeight =
