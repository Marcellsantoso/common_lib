...
public class NumberPicker
	...
	public void setTheme(int themeResId) {
		...
		if (mTheme != -1) {
			...
			mKeyBackgroundResId = a.getResourceId(
					R.styleable.BetterPickersDialogFragment_bpKeyBackground,
					mKeyBackgroundResId);
			...
			mDividerColor = a.getColor(
					...
					mDividerColor);
			mDeleteDrawableSrcResId = a.getResourceId(
					R.styleable.BetterPickersDialogFragment_bpDeleteIcon,
	...
	private void restyleViews() {
		...
		if (mDelete != null) {
			...
			mDelete.setImageDrawable(getResources().getDrawable(
					mDeleteDrawableSrcResId));
		}
	...
	/**
	 * Using View.GONE, View.VISIBILE, or View.INVISIBLE, set the visibility of the decimal
	 * indicator
	 * 
	 * @param visiblity an int using Android's View.* convention
	 */
	...
	public double getDecimal() {
		double decimal = BigDecimal.valueOf(getEnteredNumber())
				.divideAndRemainder(BigDecimal.ONE)[1].doubleValue();
		return decimal;
	}
